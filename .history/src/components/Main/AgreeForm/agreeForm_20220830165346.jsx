...
function AgreeForm({showForm,text}) {
  ...
  const handleScroll = event => {
    (event.currentTarget.scrollTop === 900 || event.currentTarget.scrollTop === 1850) && setScroll(true);
  ...
  return (
    <div>
        <div className={styles.agreeForm}>
            ...
            <div className={scroll ? styles.checkActive : styles.check} onClick={() => showForm(false)}>
